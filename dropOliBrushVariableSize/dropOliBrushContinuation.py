...
snapshot = hoomd.data.gsd_snapshot("initialConditions/dropOliBrushFinalConf" + sin + ".gsd", frame=0)
...
if (animate == 1):
	# hoomd.dump.gsd("animations/dropOliBrushTraj" + sout + ".gsd", group=all, overwrite=False, period=meas_period,dynamic=["momentum"], phase=meas_period);
