...
xcoords2 = numpy.linspace(0,oliLen-1,oliLen) # initial z coordinates of oligomers
...
if (animate == 1):
	hoomd.dump.gsd("trajectories/liqSlabFullTraj" + sout + ".gsd", group=all, overwrite=True, period=meas_period);

hoomd.run(nsteps);


hoomd.dump.gsd("initialConditions/liqSlabFull" + sout + ".gsd", group=all, overwrite=True, period=None);
